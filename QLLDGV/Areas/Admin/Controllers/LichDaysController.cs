...
namespace QLLDGV.Areas.Admin.Controllers
{
    public class LichDaysController : BaseController
    {
        ...
        public ActionResult Index(int? page, string SearchString, string currentFilter)
        {
            ...
            {
                links = db.LichDays.Include(l => l.GIAOVIEN).Include(l => l.MonHoc).Include(l => l.TietHoc).Include(l => l.TietHoc1).Include(l => l.HocPhan).Include(l => l.PHONG).Include(l => l.THU).ToList();
            }
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.NhomHP = new SelectList(db.HocPhans, "MaNhom", "TenNhom");
        ...
        public JsonResult GetNhomHPList(string MaMH)
        {
            ...
            List<HocPhan> NhomHPList = db.HocPhans.Where(x => x.MonHoc1.MaMH == MaMH).ToList();
        ...
        public ActionResult Create([Bind(Include = "MaLich,TenMH,NhomHP,PhongHoc,GVDay,ThuNgay,NgayBatDau,NgayKetThuc,GioBatDau,GioKetThuc")] LichDay lichDay)
        {
            ...
            ViewBag.NhomHP = new SelectList(db.HocPhans, "MaNhom", "TenNhom", lichDay.NhomHP);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaLich,TenMH,NhomHP,PhongHoc,GVDay,ThuNgay,NgayBatDau,NgayKetThuc,GioBatDau,GioKetThuc")] LichDay lichDay)
        {
            if (ModelState.IsValid)
            {
